...
- `site/3d/scenes/reaction-diffusion/simulation.js` -- ReactionDiffusion class (API + detailed ping-pong setup code)
- `site/3d/scenes/reaction-diffusion/main.js` -- scene setup (described, key details specified)
- `site/3d/scenes/reaction-diffusion/reaction-diffusion.frag` -- complete Gray-Scott shader code provided
- `site/3d/scenes/reaction-diffusion/reaction-diffusion.vert` -- fullscreen quad passthrough (code provided)
- `site/3d/scenes/reaction-diffusion/display.frag` -- palette-based display shader (code provided with organic, thermal, monochrome palettes)
- `site/3d/scenes/reaction-diffusion/index.html` -- HTML shell
